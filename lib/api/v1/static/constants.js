const TIPOS = [
    {
        ...
        description:
            "Estos fondos, invierten principalmente en depósitos a plazo fijo, cuentas corrientes remuneradas en entidades financieras y operaciones de pase en el Banco Central de la República Argentina, que le otorgan un alto grado de liquidez y estabilidad en sus rendimientos."
    },
    {
        id: 2,
        slug: "bonos",
        name: "Bonos",
        consultaComposicionId: "fondos-de-bonos",
        description:
...
const FONDOS_DATA = [
    {
        ...
        description:
            "Es un fondo que brinda liquidez inmediata con un rendimiento intermedio entre una caja de ahorros y un depósito a plazo fijo. Invierte principalmente en cuentas a la vista, y certificados a plazo fijo. Las inversiones se realizan con un estricto control del riesgo crediticio y un adecuado flujo de caja.",
        shortDescription:
            "Depósitos a plazo fijo, cuentas a la vista y pases pasivos en el BCRA, entre otros.",
    ...
    },
    {
        ...
        description:
            "El objetivo del fondo es maximizar el rendimiento de una cartera de activos de renta fija en pesos de mediano plazo. El patrimonio incluye valores negociables e instrumentos de renta fija públicos y privados de mediano plazo en pesos.",
        shortDescription:
    ...
    },
    {
        ...
        description:
            "El nuevo objetivo del fondo es obtener una renta real positiva frente a la inflación en el largo plazo, con una estrategia de volatilidad moderada. Invertirá principalmente en activos que ajusten por índice CER, el cual indica la variación en el índice de precios al consumidor.",
        shortDescription:
            "Invertirá principalmente en activos que ajusten por índice CER, el cual indica la variación en el índice de precios al consumidor.",
        currency: CURRENCIES[1]
    },
    {
        id: "rentadolaresi",
        ...
        description:
            "Obtener rentabilidad en el corto plazo de una cartera de bonos en dólares. Brinda liquidez en 48 horas y requiere una inversión inicial de tan sólo USD100. Las suscripciones y rescates se realizan en dólares desde una cuenta de la misma moneda.",
        shortDescription:
            "El fondo buscará obtener rentabilidad en el corto plazo de una cartera de inversiones en dólares dirigida a cliente minorista principalmente.",
    ...
    },
    {
        ...
        shortDescription:
            "Obtener rentabilidad en el mediano plazo de una cartera de bonos en dólares. Brinda liquidez en 48 horas y requiere una inversión inicial de tan sólo USD100.",
        currency: CURRENCIES[2]
    },
    {
        id: "acciones",
    ...
    },
    {
        ...
        shortDescription:
            "Acciones del panel Merval de la Bolsa de Comercio de Buenos Aires con una inversión mínima requerida de cien pesos.",
        currency: CURRENCIES[1]
    }
];
